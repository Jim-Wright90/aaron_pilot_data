...
These scatter plots display the linear relationship between session duration and the number of correct trials observed per session. These plots appear to be a good representation of treatment endurance. 
